...
export default function Projects() {
  ...
  return(
    ...
    <br/> <a className="appLink" href="https://moodboardwebsitebuilder.onrender.com" target="_blank">Deployed App</a> · <a className="appLink"  href="https://github.com/mjchin1/Moodboard-WebsiteBuilder" target="_blank">GitHub Repository </a>
   ...
   <br/> <a className="appLink" href="https://thefieldtrip.onrender.com" target="_blank">Deployed App</a> · <a className="appLink" href="https://github.com/mjchin1/TheFieldTrip-ChicagoDirectory" target="_blank">GitHub Repository </a>
    </p>
    <div className="breakline"></div>
