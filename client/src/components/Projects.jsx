...
export default function Projects() {
  ...
  return(
    ...
    <h2>Moodboard</h2>
    <p>
    A full-stack website-building app <br/>
    React.js · Node.js · PostgreSQL · Express.js · Redux · RTK Query <br/> <br></br>
  ...
  Deployed App · GitHub Repository
    ...
    <p>
    A full-stack directory of unique Chicago locations <br/>
